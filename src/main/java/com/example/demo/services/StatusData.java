...
import com.example.demo.models.CovidStatus;
import com.example.demo.models.LatLng;
...
//            Extracting Global and Country wise status
              ...
              this.setNewRecoverd(newRecoverd);
              this.setNewDeaths(newDeaths);
              this.setTotalConfirmed(totalConfirmed);
              this.setTotalRecoverd(totalRecoverd);
    ...
    public String getNewRecoverd() {
        return newRecoverd;
    }

    public void setNewRecoverd(String newRecoverd) {
